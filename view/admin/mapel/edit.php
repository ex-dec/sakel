                ...
                <section class="section">
                    ...
                    <div class="section-body">
                        ...
                        <p class="section-lead">
                            Silahkan isi form berikut untuk mengedit Mapel.
                        </p>
                                        ...
                                        <form method="post" action="/admin/mapel/update">
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" class="form-control" name="name" id="name" value="<?= $mapel['name'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <button class="btn btn-primary" type="submit">Edit Mapel</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
