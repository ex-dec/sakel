            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        ...
                        <h1>Buat Siswa Baru</h1>
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                            <div class="breadcrumb-item"><a href="#">Siswa</a></div>
                            <div class="breadcrumb-item">Buat Siswa Baru</div>
                        </div>
                    </div>

                    <div class="section-body">
                        <h2 class="section-title">Buat Siswa Baru</h2>
                        <p class="section-lead">
                            Silahkan isi form berikut untuk membuat Siswa baru.
                        </p>
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="/admin/siswa/store">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <button class="btn btn-primary" type="submit">Buat Siswa</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
