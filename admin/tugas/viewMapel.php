                ...
                <section class="section">
                    <div class="section-header">
                        <div class="section-header-back">
                            <a href="/admin/tugas" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                        </div>
                        <h1>Tugas</h1>
                        ...
                        <?php if (!empty($mapel)) {
                            foreach ($mapel as $index => $mapel): ?>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <a href="/admin/tugas/index.php?mapel_id=<?=$mapel['id']?>&kelas_id=<?=$kelas_id?>" style="text-decoration: none; color: inherit;">
