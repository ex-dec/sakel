                ...
                <section class="section">
                    <div class="section-header">
                        <div class="section-header-back">
                            <a href="/admin/kelas" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                        </div>
                        <h1>Buat Kelas Baru</h1>
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                            <div class="breadcrumb-item"><a href="#">Kelas</a></div>
                            <div class="breadcrumb-item">Buat Kelas Baru</div>
                        </div>
                    </div>
                    ...
                    <div class="section-body">
                        ...
                        <p class="section-lead">
                            Silahkan isi form berikut untuk membuat Kelas baru.
                        </p>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" action="/admin/kelas/create/service.php">
