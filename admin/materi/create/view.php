                ...
                <section class="section">
                    <div class="section-header">
                        <div class="section-header-back">
                            <a href="/admin/materi/index.php?mapel_id<?=$mapel_id?>" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                        </div>
                    ...
                    <div class="section-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" action="/admin/materi/create/service.php">
